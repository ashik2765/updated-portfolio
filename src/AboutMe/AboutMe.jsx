            ...
            <div className="container mx-auto text-center">
                ...
                <div className="max-w-2xl mx-auto mb-10">
                    <p className="text-gray-700 leading-loose">
                        Hi there! i am YourName, a passionate web developer with a keen interest in creating innovative and user-friendly websites.
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <p className="text-gray-700 mb-4">Bachelor of Science in Computer Science - Your University (Year)</p>
